        ...
        <div className='flex flex-col w-full items-center my-10'>
          ...
          <div className=' flex justify-center flex-wrap items-center my-10 gap-10  '>
            ...
            <div className='flex flex-col max-w-md max-lg:max-w-full  max-flex-wrap justify-center items-center my-4 gap-5'>
              <p className='text-xl text-gray-700 font-bold my-10 dark:text-white text-wrap text-justify'>"Get back to ANICRYPTO before this adorable cutiepie gets wrecked by another auto while pretending his squeaky bicycle is a Ducati. Last time, he got turned into road art, dragged himself to a clinic, and got treated by a ‘doctor’ who proudly claimed he got his medical degree from McDonald’s"</p>
